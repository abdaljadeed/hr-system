<x-app-layout>
    @section('breadcrumb')
        <x-breadcrumb :items="[['label' => 'Employees', 'href' => route('employees.index')], ['label' => $employee->full_name, 'href' => route('employees.show', $employee)], ['label' => 'Edit']]" />
    @endsection
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('employees.show', $employee) }}" class="text-gray-400 hover:text-gray-600">
                {{ $employee->full_name }}
            </a>
            <span class="text-gray-300">/</span>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="2"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">{{ old('address', $employee->address) }}</textarea>
